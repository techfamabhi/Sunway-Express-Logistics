...
class FrontController extends Controller
{
    public function indexpage()
    {
        ...
        $testi=DB::table('testimonials')
                ->select('*')
                ->get();
        return view('frontend2.index',compact('about','client','service','testi'));
    }
    public function aboutpage()
    {
        return view('frontend2.about');
    }
    public function servicepage()
    {
        ...
        return view('frontend2.service',compact('testi','serv'));
    }
    public function service_details($id)
    {
        ...
        $serv=DB::table('tbl_services')
                ...
                ->select('*')
                ->first();
        return view('frontend2.service_details',compact('serv'));
    }
    public function gallery()
    {
        $gallery=DB::table('tbl_galleries')
                    ->select('*')
                    ->get();
        return view('frontend2.gallery',compact('gallery'));
    }
    public function people_corner()
    {
        $people=DB::table('careers')
                    ->select('*')
                    ->get();
        return view('frontend2.career',compact('people'));
    }
    public function about_ALS()
    {
        $about_als=tbl_about::get();
        return view('frontend2.about_ALS',compact('about_als'));
    }
    public function management()
    {
        $management=management::get();
        return view('frontend2.management',compact('management'));
    }
    public function vision_mission()
    {
        $vision_mission=vision_mission::get();
        return view('frontend2.vision_mission',compact('vision_mission'));
    }
    public function envisioning_the_future()
    {
        $envisioning_the_future=envisioning_future::get();
        return view('frontend2.envisioning_futures',compact('envisioning_the_future'));
    }
    public function milestones_achievements()
    {
        $milestones=milestones_achievement::get();
        return view('frontend2.milestones_achievements',compact('milestones'));
    }
    public function contact()
    {
        $serv=DB::table('tbl_services')
                ->select('*')
                ->get();
        return view('frontend2.contact',compact('serv'));
    }
    ...
    public function search(Request $request)
    {
        ...
        if($serv>0)
        {
            $serv=DB::table('tbl_services')
                ...
                ->select()
                ->get();
            return view('frontend2.search_service',compact('serv'));
        }
        else
        {
            return view('frontend2.search_service_empty');
        }
